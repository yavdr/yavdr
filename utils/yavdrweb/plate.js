...
*/
	...
	document.getElementById('menu').className = 'show';
      var url = "components?tab=" + escape(input);
...
function show_prog( input ) {
	document.getElementById('top_task').style.display = "none";
	document.getElementById('programs').className = '';
	document.getElementById('menu').className = 'show';
      var url = escape(input);
...
function show_tty_selection(select) {
  var driver = document.getElementById("drivers").options[select.options.selectedIndex].value;
  if (driver == "serial")
    document.getElementById("select_tty").style.visibility = "visible";
  else
    document.getElementById("select_tty").style.visibility = "hidden";
}
