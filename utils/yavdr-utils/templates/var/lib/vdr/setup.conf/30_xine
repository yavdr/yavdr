...
xine.modeLiveTV.monitoringMode = monitoringContinuous
xine.modeLiveTV.prebufferFramesAudio = 6
xine.modeLiveTV.prebufferFramesVideoHD = 16
xine.modeLiveTV.prebufferFramesVideoSD = 6
xine.modeLiveTV.prebufferHysteresis = 6
xine.osdMode = osdBlendScaledSHQ
