...
xineliboutput.OSD.Width = 1280
xineliboutput.OSD.Height = 720
...
xineliboutput.Media.BrowseFilesDir = /media/Video
xineliboutput.Media.BrowseImagesDir = /media/Picture
xineliboutput.Media.BrowseMusicDir = /media/Music
